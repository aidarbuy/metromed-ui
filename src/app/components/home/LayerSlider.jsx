  ...
  render() {
    return (
      <div id="layerslider" ref="layerslider" style={styles.main}>
        ...
        {/* 11000 30-32, 69-72 */}
        <div className="ls-slide" data-ls="slidedelay:11000; transition2d: 15-18, 59-61, 90, 91, 30-32, 69-72, 40-43, 92, 96, 97, 75-79, 81, 82, 86, 87-89, 93-95, 111, 103-105, 109, 112">
        ...
        <div className="ls-slide" data-ls="slidedelay:10500; transition2d: 15-18, 59-61, 90, 91, 30-32, 69-72, 40-43, 92, 96, 97, 75-79, 81, 82, 86, 87-89, 93-95, 111, 103-105, 109, 112">
          <img className="ls-bg" src="images/layerslider/image-3.jpg" alt="Slide background" />
          <h4 className="ls-l" style={{top: 100, left: 125, whiteSpace: 'nowrap', fontSize: 70, fontWeight: 'normal', color: '#F50057'}} data-ls="offsetxin:0; offsetyin:top; durationin:3000; delayin:300; easingin:easeOutElastic; fadein:false; offsetxout:left; durationout:1500; showuntil:5400; easingout:easeInBack; fadeout:false;">Playful</h4>
          <h3 className="ls-l" style={{top: 175, left: 120, whiteSpace: 'nowrap', fontSize: 100, fontWeight: 'normal', color: '#FF5722'}} data-ls="offsetxin:0; offsetyin:top; durationin:3000; delayin:200; easingin:easeOutElastic; fadein:false; offsetxout:left; durationout:1500; showuntil:5950; easingout:easeInBack; fadeout:false;">Pediatric</h3>
          <h4 className="ls-l" style={{top: 290, left: 390, whiteSpace: 'nowrap', fontSize: 70, fontWeight: 'normal', color: '#F50057'}} data-ls="offsetxin:0; offsetyin:top; durationin:3000; delayin:100; easingin:easeOutElastic; fadein:false; offsetxout:left; durationout:1500; showuntil:5250; easingout:easeInBack; fadeout:false;">Care</h4>
          <h5 className="ls-l" style={{top: 450, left: 125, fontSize: 25, color: '#FF3D00'}} data-ls="offsetxin:-100; offsetxout:0; offsetyin:0; offsetyout:bottom; durationin:2500; delayin:2000; skewxin:60;">When medical treatment is fun :)</h5>
